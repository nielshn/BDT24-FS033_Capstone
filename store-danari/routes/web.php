...
Route::get('register-success', [RegisteredUserController::class, 'registerSuccess'])->name('front.registerSuccess');
...
Route::get('success', [CartController::class, 'checkoutSuccess'])->name('front.success');
